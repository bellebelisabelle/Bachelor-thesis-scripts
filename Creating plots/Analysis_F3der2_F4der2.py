...
plt.xlabel(r'$h$')
plt.ylabel(r'$\theta$')
plt.savefig("Figures/Analysis_F3der2z.pdf", dpi=300, bbox_inches='tight')
plt.plot()
...
plt.xlabel(r'$h$')
plt.ylabel(r'$\theta$')
plt.savefig("Figures/Analysis_F3der2v.pdf", dpi=300, bbox_inches='tight')
plt.show()
...
plt.xlabel(r'$h$')
plt.ylabel(r'$\theta$')
plt.savefig("Figures/Analysis_F4der2z.pdf", dpi=300, bbox_inches='tight')
plt.plot()
...
plt.xlabel(r'$h$')
plt.ylabel(r'$\theta$')
plt.savefig("Figures/Analysis_F4der2v.pdf", dpi=300, bbox_inches='tight')
plt.show()
