...
plt.ylim([0, 1])
plt.legend()
plt.savefig("Figures/Plot_Fpi.pdf", dpi=300, bbox_inches='tight')
plt.show()

#%% F0 for p = 0.35
p = 0.35
h = 1.0
thetas = np.array([0.9, 2, 3])
...
plt.xlim([0, 1])
plt.ylim([0, 1])
plt.savefig("Figures/Plot_F0.pdf", dpi=300, bbox_inches='tight')
plt.show()
...
plt.xlim([0, 1])
plt.ylim([0, 1])
plt.savefig("Figures/Plot_F3.pdf", dpi=300, bbox_inches='tight')
plt.show()
...
plt.xlim([0, 1])
plt.ylim([0, 1])
plt.savefig("Figures/Plot_F4.pdf", dpi=300, bbox_inches='tight')
plt.show()
